                    ...
                    <div class="card">
                        ...
                        <div class="card-footer primary-background text-center">
                            <%
                              ...
                              %>
                              <a href="#" onclick="doLike(<%= post.getIdPost() %>,<%= user.getId() %>)" class="btn btn-outline-light btn-sm"> <i class="fa fa-thumbs-o-up"></i> <span class="like-counter"><%= ldao.countLikeOnPost(post.getIdPost()) %></span></a>
